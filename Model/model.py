...
class EyeBlinkNet(nn.Module):
    ...
    def __init__(
        self,
        input_size: int,
        fc_sizes = constants.Training_Constants.eye_image_constants.FC_SIZES,
        lstm_hidden: int = constants.Training_Constants.eye_image_constants.LTSM_HIDDEN,
        lstm_layers: int = constants.Training_Constants.eye_image_constants.LTSM_LAYERS,
        bidirectional: bool = constants.Training_Constants.eye_image_constants.BIDIRECTIONAL,
    ):
        super().__init__()
        self.layers = nn.ModuleList()
        in_dim = input_size
